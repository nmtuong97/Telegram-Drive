...
- Base HEAD for this working-tree audit: `39552247e10055549ed2793d6ac1188de04d900e`
...
| Real-account session/data smoke verification | Passed: Saved Messages plus `Matchic Coder`/`Matchic Notifier` appeared from TDLib, real MP4 items were classified as `video`, cards showed size/date/Remote and explicit duration-unavailable metadata, and the existing session returned after force-stop/relaunch. |
