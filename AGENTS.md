...
This project is indexed by GitNexus as **Telegram-Drive** (5714 symbols, 9926 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
