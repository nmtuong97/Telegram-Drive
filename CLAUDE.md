...
This project is indexed by GitNexus as **Telegram-Drive** (7211 symbols, 14446 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
